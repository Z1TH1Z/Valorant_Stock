...
export const FRANCHISE_TEAMS: { name: string; region: string }[] = [
  ...
  { name: 'ENVY',           region: 'americas' },
  { name: 'FURIA',          region: 'americas' },
  { name: 'G2 Esports',     region: 'americas' },
  // EMEA
  ...
  { name: 'Eternal Fire',   region: 'emea' },
  { name: 'Gentle Mates',   region: 'emea' },
  { name: 'PCIFIC Esports', region: 'emea' },
  // Pacific
